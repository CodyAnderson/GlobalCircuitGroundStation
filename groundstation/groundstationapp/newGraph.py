...
def FlightID_IMEI_Cond_RAW(request):
  ...
  for x in filteredDataRows['ConductivityMeasurements']:
    ...
    fullCondPackList = models.PacketV6Units.objects.filter(parent_packet_v6__mcu_id = '1')
    fullCondPackList = fullCondPackList.filter(parent_packet_v6__parent_transmission__imei = '300434063382350')
