...
def googleMap(request):
  ...
  ordered_gpsmeasurements = models.SlowMeasurement.objects.order_by('-global_id__global_id__transmit_time')[:10]
  ...
  for x in ordered_gpsmeasurements:
    ...
    tempDateString = str(tempDateTime.astimezone(tzinfo=dt.timezone.utc))
